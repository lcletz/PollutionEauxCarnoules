# Folder "Correlations_and_Predictions" description
...
Run main_script.Rmd from the root folder first!
...
3) S1_predictions.Rmd

4) COWG_predictions.Rmd

5) S1_by_COWG_predictions.Rmd

6) S1_by_limited_COWG_predictions.Rmd

The other files are previous analysis and can be ignored. There is no right order to open them.
